...
func panelSwitcherEntries() []panelSwitcherEntry {
	return []panelSwitcherEntry{
		...
		{Label: "Provider Config", KeyHint: "F8 · Alt+8", Activate: "Providers", Hint: "advanced provider catalog + keys"},
		{Label: "Status", KeyHint: "F9", Activate: "Status", Hint: "engine + provider snapshot"},
		{Label: "CodeMap", KeyHint: "F10", Activate: "CodeMap", Hint: "symbol + dep graph"},
		{Label: "Tools", KeyHint: "F11", Activate: "Tools", Hint: "tool registry + params"},
		...
		{Label: "ProviderLog", KeyHint: "Shift+F7", Activate: "ProviderLog", Hint: "every provider call (model · in/out tokens · preview)"},
