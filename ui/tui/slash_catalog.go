...
func (m Model) slashCommandCatalog() []slashCommandItem {
	...
	extras := []slashCommandItem{
		...
		{Command: "shortcuts", Template: "/shortcuts", Description: "open the help overlay (same as ctrl+h or alt+h) · /keys + /cheatsheet are aliases"},
		...
		{Command: "history", Template: "/history search ", Description: "search transcript: /history search <q> for matches · /history list for a turn-by-turn TOC"},
		{Command: "jump", Template: "/jump ", Description: "/jump N scrolls the transcript so assistant turn #N is back in view (pair with /history search)"},
		{Command: "expand", Template: "/expand ", Description: "/expand N opens a long assistant turn that was collapsed to the head preview · /expand all opens everything"},
		{Command: "collapse", Template: "/collapse ", Description: "/collapse N re-collapses an /expand'ed turn · /collapse all snaps all turns back to head preview"},
		{Command: "toolshow", Template: "/toolshow ", Description: "/toolshow N prints the full detail of the N-th tool event inline (last for the most recent)"},
		{Command: "next", Template: "/next", Description: "after /history search, /next jumps to the next matched row (wraps around)"},
		{Command: "prev", Template: "/prev", Description: "after /history search, /prev jumps to the previous matched row (wraps around)"},
