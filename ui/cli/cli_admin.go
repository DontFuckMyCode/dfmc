...
// man pages, doctor, and config. Extracted from cli.go so the dispatcher
// stays focused. These commands share formatting helpers for engine
// status, provider profiles, AST/codemap metrics, and config shape so
